        ...
        records: [
            {
                ...
                sourceText: "人工智能正在改变我们处理写作任务的方式，它不仅提升效率，还帮助我们更快组织思路。",
                sourceLang: "中文",
                translationEnabled: true,
                targetLang: "英文",
                translatedText: "Artificial intelligence is reshaping how we handle writing tasks, improving efficiency and helping us structure ideas faster.",
                translationStatus: "success"
            },
            {
                id: "r-2",
                createdAt: new Date(now - 1000 * 60 * 40).toISOString(),
                sourceText: "世界是一个不断探索的过程，每一次记录，都是对思考的梳理。",
                sourceLang: "中文",
                translationEnabled: true,
                targetLang: "日文",
                translatedText: "世界は探求の連続であり、一つひとつの記録は思考を整理する行為です。",
                translationStatus: "success"
            }
        ]
    },
